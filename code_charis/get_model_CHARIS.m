function [y_hat, y, taxis, all_pulses, pt_tilda, R2, T] = get_model_CHARIS(...
...
if do_plot
    ...
    subplot(211);
    plot(taxis_ts, ts, 'b', 'LineWidth', 1.5); hold on;
...
% nsamples_train = nsamples-nsamples_test; disp(nsamples_train)
% 
% y_temp_copy = y_temp;
